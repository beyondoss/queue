-- Vendored from pgmq v1.11.1 (https://github.com/tempostorm/pgmq)
-- Used as the baseline for benchmarking pgmq-rx vs upstream PL/pgSQL.
-- To update: copy pgmq-extension/sql/pgmq.sql from the upstream repo at the desired tag.
------------------------------------------------------------
