...
export interface components {
    schemas: {
        ...
        /**
         * @description Request body to create a topic subscription. Provide either `queue_name` (to route
        ...
        /** @description Request body for publishing a message to a topic. */
        TopicSendRequest: {
            /**
             * Format: int32
        ...
        /** @description Result of a topic publish operation. */
        TopicSendResponse: {
        ...
        TopicSubscription: {
            ...
            /**
             * Format: int64
             * @description Subscription ID. Use this to unsubscribe via `DELETE /v1/topics/{pattern}/subscriptions/{id}`.
             */
            id: number;
...
export interface operations {
    ...
    list_topic_subscriptions: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description Exact topic pattern to look up. */
                pattern: string;
            };
            cookie?: never;
        };
    ...
    subscribe: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description Glob pattern matched against routing keys at publish time (e.g. `payments.*`, `**` to match all topics). */
                pattern: string;
            };
            cookie?: never;
        };
    ...
    unsubscribe: {
        parameters: {
            ...
            header?: never;
            path: {
                /** @description Topic pattern (for URL structure; the subscription ID alone uniquely identifies the record). */
                pattern: string;
