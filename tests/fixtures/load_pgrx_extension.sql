-- Register the pgrx-compiled hot-path functions from beyond_queue.so.
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'send_full_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'send_batch_internal_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'pop_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'change_visibility_ts_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'change_visibility_secs_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'change_visibility_batch_ts_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'change_visibility_batch_secs_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'send_fifo_full_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'receive_fifo_fn_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'publish_event_pgrx_wrapper';
...
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'publish_event_batch_pgrx_wrapper';
...
RETURNS VOID
LANGUAGE C VOLATILE
AS '$libdir/beyond_queue', 'invalidate_routing_cache_fn_wrapper';
